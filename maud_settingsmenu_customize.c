...
void maud_settingmenu_rendercustomizetab_musictile_modifier(maud_t* maud,
    ...
    bgcolor_btn->canvas.w = bgcolor_btn->text.text_canvas.w + 10,
    bgcolor_btn->canvas.h = bgcolor_btn->text.text_canvas.h + 10;
    ...
    textcolor_content->text_canvas.y = bgcolor_btn->text.text_canvas.y +
        bgcolor_btn->text.text_canvas.h + 20;
    ...
    textcolor_btn->canvas.w = textcolor_btn->text.text_canvas.w + 10,
    textcolor_btn->canvas.h = textcolor_btn->text.text_canvas.h + 10;
