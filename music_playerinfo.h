...
const SDL_Color window_color = {0, 0, 0, 0} /*{0x2c, 0x36, 0x5e, 0xff}/*{0x3C, 0x16, 0x42, 0xff}*/,
    ...
    setting_wincolor = {0x0D, 0x06, 0x28, 0xFF}/*{0x25, 0x16, 0x05, 0xFF}{0x21, 0x01, 0x24, 0xFF} {0x0B, 0x31, 0x42, 0xFF}{0x54, 0x08, 0x04, 0xFF}{0x1B, 0x06, 0x5E, 0xFF}black{0x20, 0x81, 0xC3, 0xFF}{0x02, 0x3C, 0x40, 0xFF}*/,
...
setting_textinfo[] = {
    ...
    {30, "Music Library", NULL, {0xFF, 0xFF, 0xFF, 0xFF} /*{0xF9, 0x62, 0x7D, 0xFF}{0xAD, 0x2E, 0x24, 0xFF}{0x0C, 0xF5, 0x74, 0xFF}{0xF7, 0xF9, 0xF9, 0xFF}{0x58, 0x72, 0x91, 0xFF}*/,
        {10, 0}},
    {30, "Personalization", NULL, {0xFF, 0xFF, 0xFF, 0xFF}, {10, 0}},
